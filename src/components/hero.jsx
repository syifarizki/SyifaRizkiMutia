  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col md:flex-row justify-center items-center">
        <div className="pr-5 text-[45px] md:text-[75px] font-black text-[#e6e4e2]">
          HELLO, I'M
        </div>
        <div className="text-[45px] md:text-[75px] font-black text-[#D6E4FF]">
          SYIFA
        </div>
      </div>
      <div className="flex justify-center items-center mx-auto max-w-2xl mt-4">
        <div className="text-center text-[#e6e4e2] text-[16px] font-medium leading-7 tracking-wider">
          Frontend Developer focused on building modern, responsive, and
          user-friendly web interfaces with a strong attention to design and
          user experience.
        </div>
      </div>
      <div className="flex justify-center mt-10 gap-5">
        <a href="https://www.linkedin.com/in/syifa-rizki-mutia-a0355729a/">
          <svg
            className="w-10 h-10"
        ...
        <a href="https://www.instagram.com/syifarizki14?igsh=MzZtMzNvNjZoYWIx">
          <svg
            className="w-10 h-10"
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
